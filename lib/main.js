...
function randomPhysics(angle, spread, x, y, startVelocity, random) {
...
function confetti(root) {
  ...
  var _Object$assign = Object.assign({}, defaults, config),
      ...
      startOffsetX = _Object$assign.startOffsetX,
      startOffsetY = _Object$assign.startOffsetY,
  ...
  var fettis = elements.map(function (element) {
    return {
      element: element,
      physics: randomPhysics(angle, spread, rootRect.width * startOffsetX, rootRect.height * startOffsetY, startVelocity, random)
    };
  });
